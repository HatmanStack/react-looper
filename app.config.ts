  ...
  return {
    ...
    plugins: [
      ...
      [
        'expo-media-library',
        {
          photosPermission: 'Allow Looper to access your photos to import and export audio files.',
          savePhotosPermission: 'Allow Looper to save mixed audio files to your photo library.',
