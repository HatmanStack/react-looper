...
describe('TrackListItem', () => {
  ...
  it('calls onPlay when play button is pressed', () => {
    ...
    const { getAllByTestId } = render(<TrackListItem track={mockTrack} onPlay={mockOnPlay} />);
  ...
  it('calls onPause when pause button is pressed', () => {
    ...
    const { getAllByTestId } = render(<TrackListItem track={mockTrack} onPause={mockOnPause} />);
  ...
  it('calls onDelete when delete button is pressed', () => {
    ...
    const { getAllByTestId } = render(<TrackListItem track={mockTrack} onDelete={mockOnDelete} />);
