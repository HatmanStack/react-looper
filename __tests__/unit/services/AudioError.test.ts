...
describe('AudioError', () => {
  ...
  it('identifies permission errors', () => {
    const permissionError = new AudioError(AudioErrorCode.PERMISSION_DENIED, 'Test');
  ...
  it('identifies recoverable errors', () => {
    const recoverable1 = new AudioError(AudioErrorCode.RECORDING_FAILED, 'Test');
    ...
    const recoverable4 = new AudioError(AudioErrorCode.RESOURCE_UNAVAILABLE, 'Test');
    const notRecoverable = new AudioError(AudioErrorCode.FILE_NOT_FOUND, 'Test');
